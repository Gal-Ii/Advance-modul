...
public class Person {
    ...
    private List<Relative> childrens;
    private Car car;
    ...
    public void addParents(Relative parents){
        this.parents.add(parents);
    }

    public void addChildren(Relative children){
    ...
    public String toString() {
        ...
        if (!this.childrens.isEmpty()) {
            this.childrens.forEach(child -> sb.append(child).append(System.lineSeparator()));
        }
        return sb.toString();
    }
